...
<style>
.site {margin: 0 auto;max-width: <?php echo $max_site_width; ?>px;width: 100%;}
.site-header{max-width: <?php echo $max_site_width; ?>px;}
...
.site:before,#secondary{width:0;display:none;}
.ie8 .site:before,.ie8 #secondary{width:0px;display:none;}
.featured-content{padding-left:0;}
.site-content, .site-main .widecolumn, .ie8 .site-content, .ie8 .site-main .widecolumn{margin-left:0;}
...
<style>
	...
	.comments-area{max-width: <?php echo $conten_max_width; ?>px;}
	.post-navigation, .image-navigation{max-width: <?php echo $conten_max_width; ?>px;}
</style>
<?php }
...
?>
<style>
	.slider .featured-content .hentry{max-height: <?php echo $overall_slider_height; ?>px;}
	.slider .featured-content{max-width: <?php echo $overall_slider_width; ?>px; margin: <?php echo $slider_margin_top; ?>px auto;}
	.slider .featured-content .post-thumbnail img{max-width: <?php echo $overall_slider_width; ?>px;width: 100%;}
	.slider .featured-content .post-thumbnail{background:none;}
	.slider .featured-content a.post-thumbnail:hover{background-color:transparent;}
</style>
<?php
